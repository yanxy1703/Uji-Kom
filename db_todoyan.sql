...
--
-- Dumping data for table `history_tasks`
--

INSERT INTO `history_tasks` (`id`, `task_name`, `deadline`, `priority`, `completed_at`, `user_id`) VALUES
(1, 'Selasa', '2025-02-22', 'High', '2025-02-22 07:43:59', 6),
(2, 'rabu', '2025-02-22', 'High', '2025-02-22 07:53:54', 6);
...
--
ALTER TABLE `history_tasks`
  ADD CONSTRAINT `history_tasks_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
